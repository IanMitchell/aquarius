...
import * as loading from './lib/core/loading.js';
import * as permissions from './lib/core/permissions.js';
import * as services from './lib/core/services.js';
import * as triggers from './lib/core/triggers.js';
import database from './lib/database/database.js';
import DirectMessageManager from './lib/managers/direct-message.js';
import GuildManager from './lib/managers/guild-manager.js';
import EmojiManager from './lib/managers/emojis.js';
import { isDirectMessage, isBot } from './lib/helpers/messages.js';
import TriggerMap from './lib/settings/trigger-map.js';
import CommandConfig from './lib/settings/command-config.js';
import Settings from './lib/commands/settings.js';
import Analytics from './lib/commands/analytics.js';
import { setupWeeklyGuildLoop } from './lib/metrics/guilds.js';
import { fixPartialReactionEvents } from './lib/discord/library-fixes.js';
